                            ...
                            <div class="profileIntro paraMargin">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-sm-6 col-sm-pull-6 col-xs-12">
                                        ...
                                        <input type="text" class="form-control" id="listingPhone"
                                               placeholder="546 - 545 - 2546">
                                    </div>
                                    ...
                                    <div class="form-group col-sm-6 col-sm-pull-6 col-xs-12">
                                        ...
                                        <input type="text" class="form-control" id="listingWebsite"
                                               placeholder="http://">
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <div class="imageUploader text-center">
                                            <div class="file-upload">
                                                <div class="upload-area">
                                                    ...
                                                    <button class="browse" type="button">Click or Drag images here
                                                    </button>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="profileIntro paraMargin">
                                ...
                                <div class="row">
                                    <div class="form-group col-sm-6 col-xs-12">
                                        ...
                                        <input type="text" class="form-control" id="linkedUrl"
                            ...
                            <div class="profileIntro paraMargin">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-4 col-sm-6 col-xs-12">
                                        ...
                                        <input type="text" class="form-control" id="tuesdayTime"
                                               placeholder="10.00am - 5.00pm">
                                    </div>

                                    <div class="form-group col-md-4 col-sm-6 col-xs-12">
                                        <label for="wednesdayTime">Wednesday</label>
                                        <input type="text" class="form-control" id="wednesdayTime"
                                               placeholder="10.00am - 5.00pm">
                                    </div>

                                    <div class="form-group col-md-4 col-sm-6 col-xs-12">
                                        <label for="thrusdayTime">Thrusday</label>
                                        <input type="text" class="form-control" id="thrusdayTime"
                                               placeholder="10.00am - 5.00pm">
                                    </div>

                                    <div class="form-group col-md-4 col-sm-6 col-xs-12">
                                        <label for="fridayTime">Friday</label>
                                        <input type="text" class="form-control" id="fridayTime"
                                               placeholder="10.00am - 5.00pm">
                                    </div>

                                    <div class="form-group col-md-4 col-sm-6 col-xs-12">
                                        <label for="saturdayTime">Saturday</label>
                                        <input type="text" class="form-control" id="saturdayTime"
                                               placeholder="10.00am - 5.00pm">
                                    </div>
